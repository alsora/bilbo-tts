...
- `.tools/bin/pixi run check` passes formatting, Ruff, strict mypy, 384 ordinary tests, 3 expected hardware skips, and 90.89 percent coverage after the pronunciation fixes.
